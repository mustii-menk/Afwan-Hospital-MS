...
if(isset($_POST[submit]))
{
	...
	if(mysqli_num_rows($qsql) >= 1)
	{
		...
		$msg = "Kindly enter Username: $rslogin[loginid] and Password is : $rslogin[password] to login Hospital System..";
		?>
...
<div class="wrapper col4">
  <div id="container">
    <h1>Kindly Enter Login Details to Recover Your Password..</h1>
