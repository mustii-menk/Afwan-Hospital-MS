...
<div class="wrapper col4">
  <div id="container">
    <div id="content">
      <h1>Welcome to Afwan Hospital</h1>
      <p>  The goal of the Hospital Management System
      ...
      <div class="homecontent">
        <ul>
          <li>
            ...
            <p class="imgholder"><a href="patient.php"><img src="images/registration.jpg" alt="" style="width:286px;height:100px;" /></a></p>
          </li>
          <li class="last">
